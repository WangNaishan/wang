...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listView.setGeometry(QtCore.QRect(0, 0, 9951, 9636))
        self.listView.setStyleSheet(
            "background-image: url(\"/home/orangepi/Downloads/yushubo/daosheng/zhangzhixuan/ui/1.jpg\")")
        ...
        # self.texopenPatientWindowtBrowser = QtWidgets.QTextBrowser(self.groupBox_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "AD检测系统"))
        ...
        self.pushButton_weights.setText(_translate("MainWindow", "查看数据库"))
        self.pushButton_img.setText(_translate("MainWindow", "图片检测"))
        self.pushButton_video.setText(_translate("MainWindow", "视频检测"))
        self.pushButton_camer.setText(_translate("MainWindow", "实时检测"))
