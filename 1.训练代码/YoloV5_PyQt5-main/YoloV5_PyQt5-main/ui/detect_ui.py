...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "结核杆菌检测系统"))

        self.label_5.setText(_translate("MainWindow", "欢迎使用痰液切片下结核杆菌检测系统"))
        ...
        self.pushButton_weights.setText(_translate("MainWindow", "选择权重文件"))
